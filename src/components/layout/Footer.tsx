...
const Footer = () => {
  const footerLinks = {
    ...
    'Stay Updated': [
      { name: 'Get the latest courses and updates delivered to your inbox.', href: '#' },
    ],
  };
        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Empowering learners worldwide with access to high-quality education from top institutions and industry experts.
            </p>
        ...
        <div className="border-t border-gray-800 mt-16 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-gray-400 text-sm">
              <p>© 2024 Cabala. All rights reserved.</p>
